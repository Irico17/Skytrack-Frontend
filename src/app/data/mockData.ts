 ...
 *
 * Alineado con el semáforo global del backend (`TrafficLightIndicator`):
 * verde < 50%, ámbar 50–80%, rojo >= 80% (UI: warning ≥50, critical ≥80).
 */
export const OCCUPANCY_CRITICAL_PCT = 80;
export const OCCUPANCY_WARNING_PCT = 50;
